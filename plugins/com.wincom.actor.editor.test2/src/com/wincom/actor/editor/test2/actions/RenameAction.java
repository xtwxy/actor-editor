...
import com.wincom.actor.editor.test2.wizards.RenameWizard;
...
public class RenameAction extends SelectionAction {
	...
	public void run() {
		ElementModel node = getSelectedElementModel();
	...
	// Helper
	private ElementModel getSelectedElementModel() {
		...
		return (ElementModel) part.getModel();
	}
}
